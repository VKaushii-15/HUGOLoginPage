...
import * as dates from "./modules/day.js"
...
document.addEventListener("click", (e) => {
  if (e.target.classList.contains("show-itineraries")) {
    showItem(elements.initModal);
    hideItem(elements.initContentContainer);s
...
const controlInit = (e) => {
  try {
    ...
    planner.showDailyPlanners(daterange);
    elements.initForm.reset();
    hideItem(elements.initModal);
  } catch(error) {
    console.error("Control Init Error:", error); 
